...
class DevServer {
  ...
  constructor(settings) {
    ...
    const {getSections, getUrls, getCollectedData} = settings.CollectorStore;
    ...
    getSections().forEach((section) => {
      ...
      this.app.get(section.route, (req, res) => {
        const
          ...
          basePath = type === ext ? sgUtil.removeFileExtension(req.url) : sgUtil.removeFileExtension(sgUtil.removeFileExtension(req.url));
