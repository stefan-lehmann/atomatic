...
class AppBuilder {
  ...
  onEndAll(cb) {
    Promise.all(this.promises).then(() => cb());
  }
  ...
  generateViewerPages() {
    ...
    gulp.src([`${source}/templates/viewer/index.pug`])
      ...
      .on('end', onEnd('viewer pages generated.'));
  ...
  generateViewerStyles() {
    ...
    gulp.src([`${source}/style/**/*.styl`, `!${source}/style/**/_*.styl`])
      ...
      .on('end', onEnd('viewer styles generated.', '*.css'));
  ...
  copyViewerAssets() {
    ...
    gulp.src([`${source}/assets/**/*`, `!${source}/assets/**/_*`])
      ...
      .on('end', onEnd('viewer assets copied.'));
  ...
  browserifyViewerScripts() {
    ...
    bundler
      ...
      .on('end', onEnd('viewer script bundle generated.', '*.js'));
